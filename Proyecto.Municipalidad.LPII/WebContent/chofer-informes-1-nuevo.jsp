...
<html lang="es">
  ...
  %>
    ...
    <div class="container">
      <div class="row">
        <form action="MantenimientoInforme?tipo=registrarInformeServicioVehicular&idAsunto=1&idEstado=1&idusuario=${sessionScope.USUARIO.idUsuario}&txtFecha=<%=DateToStr %>" class="form-horizontal" name="" method="POST">
        <div class="form-group">
            <label for="inputFechaInforme" class="col-sm-3 control-label">Fecha Informe</label>
            <div class="col-sm-5">
              <input type="text" class="form-control" id="inputFechaInforme" value="<%=DateToStr %>" required disabled="disabled">
            </div>
          </div>
          <div class="form-group">
