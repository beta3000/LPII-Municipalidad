      ...
      <div class="row">
        <nav class="navbar navbar-default" role="navigation">
          ...
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="a-escritorio.jsp">Escritorio</a>
          </div>
          <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a href="MantenimientoVehiculo?tipo=listar">Vehículos</a></li>
                  <li><a href="MantenimientoTallerMecanico?tipo=listar">Talleres Mecánicos</a></li>
                </ul>
              </li>
            </ul>
