...
public class UsuarioDTO {
	...
	public void setIdAreaMunicipal(int idAreaMunicipal) {
		this.idAreaMunicipal = idAreaMunicipal;
	}


	public String getNombreAreaMunicipal() {
		return nombreAreaMunicipal;
	}


	public void setNombreAreaMunicipal(String nombreAreaMunicipal) {
		this.nombreAreaMunicipal = nombreAreaMunicipal;
	}
