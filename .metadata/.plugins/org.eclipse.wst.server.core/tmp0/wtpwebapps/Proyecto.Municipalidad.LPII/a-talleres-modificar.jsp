...
<html lang="es">
  ...
  <body>
    ...
    <div class="container">
      <div class="row">
        <form action="MantenimientoTallerMecanico?tipo=modificar&idTaller=${requestScope.tallerMecanico.idTallerMecanico}" class="form-horizontal" name="" method="POST">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-5">
              <select name="selectDistrito" id="selectDistrito" class="form-control">
                <ct:cboDinamico sql="SQL_DISTRITO" nombre="cboDistrito" valor="${requestScope.tallerMecanico.idDistrito}"></ct:cboDinamico>
            </select>
            </div>
          </div>
          <div class="form-group">
